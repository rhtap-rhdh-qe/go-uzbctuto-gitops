...
export GITOPS_REPO_URL=https://github.com/rhtap-rhdh-qe/go-uzbctuto-gitops
...
export COSIGN_PUBLIC_KEY="LS0tLS1CRUdJTiBQVUJMSUMgS0VZLS0tLS0KTUZrd0V3WUhLb1pJemowQ0FRWUlLb1pJemowREFRY0RRZ0FFeUVncmRpVFRCLzFuQWg2T2c2ZmJzRFJkOEhFVgo0U2oxallIakZxblBldlpJSUttOUc2Zm96NDFSUXBKQ3FHbVUrWmtJVVdBUmtCUzc3MWVQOXVXaERRPT0KLS0tLS1FTkQgUFVCTElDIEtFWS0tLS0tCg=="
...
export REKOR_HOST=${REKOR_HOST-https://rekor-server-tssc-tas.apps.rosa.kx-2f47ec4020.3175.p3.openshiftapps.com}
...
export TUF_MIRROR=${TUF_MIRROR-https://tuf-tssc-tas.apps.rosa.kx-2f47ec4020.3175.p3.openshiftapps.com}
